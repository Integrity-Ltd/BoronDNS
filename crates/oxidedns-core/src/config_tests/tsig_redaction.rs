    ...
    fn primary_config_enforces_exact_limit_and_same_handle_growth_fence() {
        ...
        let path = unique_test_path("oxidedns-primary-config-limit");
    ...
    fn static_tsig_secret_file_enforces_exact_limit_and_growth_fence() {
        ...
        let path = unique_test_path("oxidedns-static-tsig-secret-limit");
    ...
    fn static_tsig_aggregate_budget_counts_repeated_files_at_exact_and_plus_one() {
        ...
        let path = unique_test_path("oxidedns-static-tsig-aggregate");
    ...
    fn rejects_tsig_secret_symlinks_and_non_regular_files() {
        ...
        let link = unique_test_path("oxidedns-tsig-secret-link");
        ...
        let directory = unique_test_path("oxidedns-tsig-secret-directory");
