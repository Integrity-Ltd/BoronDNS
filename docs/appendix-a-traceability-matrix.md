...
| ODS-FR-XOT-001..ODS-FR-XOT-011 | MVP / Partial | `scripts/interop-knot-xot-docker.sh`; `scripts/interop-knot-xot-tsig-docker.sh`; `config/oxidedns.example.toml`; `docs/implementation-plan.md`; `docs/mvp-gap-register.md` | Add broader real-primary XoT evidence beyond Knot and map TLS, ALPN, trust-anchor, mTLS, failure, and no-cleartext-fallback cases by requirement. |
