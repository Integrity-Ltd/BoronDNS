...
| Memory growth | During the 30-day soak, RSS at day 30 remains within 10% of the 24-hour baseline for stable workload conditions, matching `BDS-NFR-REL-003` | soak report with RSS samples and workload description |
