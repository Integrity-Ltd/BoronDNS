...
| `borondns-0.2.0-x86_64-unknown-linux-musl-boron-gun.bin` | `a069c764d5096ee5d1535736d5b6dcb846d27a09433b75306083b9b6cac3cc3d` |
...
`boron-gun`. The Docker image manifest records `borondns:0.2.0`,
...
- Ubuntu 24.04 installer smoke covering fresh install, update, `borondns
  check-config`, `boron-gun --self-test`, and short `borondns serve` startup;
