...
- `oxidedns`, target `x86_64-unknown-linux-musl`, release profile, package
  `oxidedns-cli`, feature `af-xdp`.
...
`SOURCE_DATE_EPOCH`, `OXIDEDNS_BUILD_COMMIT`,
`OXIDEDNS_BUILD_RUST_VERSION`, `OXIDEDNS_BUILD_TIMESTAMP`, and
`CARGO_INCREMENTAL=0`.
...
| --- | --- | --- | --- | --- |
| `oxidedns` | `bf5f02929c08eb3cb5c3b9cb6bc68915599ee1686931477768aadfb375f0d113` | `bf5f02929c08eb3cb5c3b9cb6bc68915599ee1686931477768aadfb375f0d113` | `7899880` | yes |
