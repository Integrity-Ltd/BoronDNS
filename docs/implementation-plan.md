...
- authorized signed NOTIFY messages with BADKEY, BADSIG, BADALG, or BADTRUNC verification failures receive NOTAUTH responses carrying zero-MAC TSIG error records, and BADTIME failures receive signed NOTAUTH TSIG error records with server-time other data.
