...
- focused in-process tests cover successful XoT AXFR, XoT+TSIG AXFR, and TLS-handshake failure without cleartext retry. Real-primary XoT interop and the full TLS fault matrix remain pending.
