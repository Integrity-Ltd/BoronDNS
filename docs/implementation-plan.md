...
- `scripts/audit-spoof-evidence.py` records repeatable static evidence for SRS v0.7 `ODS-FR-SPOOF-001..007`, including CSPRNG QID selection, kernel ephemeral UDP binding, connected UDP response source filtering, QID and question-section validation tests for SOA/AXFR/IXFR, and SOA poll warning-log evidence.
