...
| AXFR and outbound response validation | Alpha plus Engineering MVP extensions | ODS-FR-SPOOF-001..ODS-FR-SPOOF-007; ODS-FR-AXFR-001..ODS-FR-AXFR-026 | Partial | docs/appendix-a-traceability-matrix.md; docs/mvp-gap-register.md; scripts/audit-spoof-evidence.py; AXFR interop scripts | Parser, anti-spoofing, primary-interop, strict out-of-zone owner rejection, fail-closed publication validation, DNAME multiplicity, and transfer-size evidence exists. Release acceptance still needs broader fault-injection, multi-primary, and retained primary-version refresh evidence. |
