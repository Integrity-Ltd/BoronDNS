...
- Final release commit must bump the workspace package version, internal
  crate-dependency versions, eBPF support-crate versions, and checked-in lockfile
  package entries to `0.2.0`.
...
- Apply the final `0.2.0` version bump and regenerate lockfiles.
