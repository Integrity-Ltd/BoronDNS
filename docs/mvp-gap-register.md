...
| Selected XoT release breadth | `docs/xot-release-evidence-v0.2.0.md` records a 3 of 3 local retained XoT pass for Knot DNS 3.5.3 XoT AXFR, Knot DNS 3.5.3 XoT+TSIG AXFR, and BIND 9.20.23 catalog-zone transfer over XoT+TSIG, with redacted retained artifacts under `target/evidence/xot-release-20260614T014700Z`. | Formal XoT acceptance still needs broader failure-class, mTLS, default-port, prohibited-suite, and optional NSD XoT evidence. |
