...
| Alpha audit confirmations | Existing architecture, security, unsafe-boundary, logging, and privilege-drop evidence cover the confirmed topics | Keep release traceability current as v0.9/v0.9.1 requirement text is cleaned up and normalized |
