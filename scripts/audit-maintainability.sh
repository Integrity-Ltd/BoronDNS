...
module_map = [
    ...
    ("crates/oxidedns-server/src/observability.rs", "in-process JSON observability/management API with bearer-token auth"),
    ...
    ("crates/oxidedns-server/src/secret_store.rs", "reloadable filesystem-backed TSIG/XoT secret store"),
