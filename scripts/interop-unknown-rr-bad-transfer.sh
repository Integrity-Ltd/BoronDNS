...
ODS-FR-URR-009	retained-runtime	rrtype0; opt; tkey; tsig; ixfr; axfr; mailb; maila; any; rrtype65535	unknown-rr-bad-transfer-summary.tsv; cases/*/oxidedns.log; cases/*/metrics.txt; cases/*/readyz.txt	Each prohibited pseudo/meta/reserved RR type in SRS v0.7 URR-009 is injected into an initial AXFR; OxideDNS logs the AXFR validation failure, increments the AXFR failed counter, remains not-ready, and exposes zero active zones.
EOF
