...
ODS-FR-AXFR-021	supporting-config	happy_path_with_configured_timeout	oxidedns.toml; docs/engineering-mvp-scope.md	The retained config sets axfr_timeout_secs=5 and the transfer completes within it; stalled-timeout failure needs separate fault evidence.
