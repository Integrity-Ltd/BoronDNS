...
This is the local MVP handoff for ODS-VER-011. It is not proof that hosted CI or
...
This is the local MVP handoff for ODS-NFR-MAINT-008. It does not sign artifacts.
