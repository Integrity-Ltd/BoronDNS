...
artifact_dir="${OXIDEDNS_PRIMARY_MATRIX_ARTIFACT_DIR:-$repo_root/target/evidence/primary-matrix-$run_id}"
...
run_case "BIND" "axfr" "bind-axfr" "OXIDEDNS_BIND_AXFR_ARTIFACT_DIR" "scripts/interop-bind-axfr.sh"
run_case "BIND" "tsig_axfr" "bind-tsig-axfr" "OXIDEDNS_BIND_TSIG_AXFR_ARTIFACT_DIR" "scripts/interop-bind-tsig-axfr.sh"
run_case "BIND" "notify_refresh" "bind-notify-refresh" "OXIDEDNS_BIND_NOTIFY_ARTIFACT_DIR" "scripts/interop-bind-notify-refresh.sh"
run_case "BIND" "ixfr_refresh" "bind-ixfr-refresh" "OXIDEDNS_BIND_IXFR_ARTIFACT_DIR" "scripts/interop-bind-ixfr-refresh.sh"
run_case "NSD" "axfr" "nsd-axfr" "OXIDEDNS_NSD_AXFR_ARTIFACT_DIR" "scripts/interop-nsd-axfr-docker.sh"
run_case "NSD" "tsig_axfr" "nsd-tsig-axfr" "OXIDEDNS_NSD_TSIG_AXFR_ARTIFACT_DIR" "scripts/interop-nsd-tsig-axfr-docker.sh"
run_case "NSD" "notify_refresh" "nsd-notify-refresh" "OXIDEDNS_NSD_NOTIFY_ARTIFACT_DIR" "scripts/interop-nsd-notify-refresh-docker.sh"
run_case "Knot" "axfr" "knot-axfr" "OXIDEDNS_KNOT_AXFR_ARTIFACT_DIR" "scripts/interop-knot-axfr-docker.sh"
run_case "Knot" "tsig_axfr" "knot-tsig-axfr" "OXIDEDNS_KNOT_TSIG_AXFR_ARTIFACT_DIR" "scripts/interop-knot-tsig-axfr-docker.sh"
run_case "Knot" "notify_refresh" "knot-notify-refresh" "OXIDEDNS_KNOT_NOTIFY_ARTIFACT_DIR" "scripts/interop-knot-notify-refresh-docker.sh"
run_case "Knot" "ixfr_refresh" "knot-ixfr-refresh" "OXIDEDNS_KNOT_IXFR_ARTIFACT_DIR" "scripts/interop-knot-ixfr-refresh-docker.sh"
run_case "PowerDNS" "catalog_tsig" "powerdns-postgres-catalog-tsig" "OXIDEDNS_POWERDNS_CATALOG_TSIG_ARTIFACT_DIR" "scripts/interop-powerdns-postgres-catalog-tsig-docker.sh"
