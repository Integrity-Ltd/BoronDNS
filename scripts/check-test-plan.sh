...
require_text "scripts/check-unsafe-prone-dependencies.py"
require_text "cargo clippy --workspace --all-targets --all-features -- -D warnings"
...
require_text "Hosted continuous CI for every main-branch candidate is intentionally deferred"
...
require_text "Engineering MVP execution requirement"
require_text "standing calendar commitment"
require_text "scripts/capture-unsafe-dependency-evidence.sh"
require_text "campaign-summary.tsv"
require_text "scripts/capture-interface-compatibility-evidence.sh"
...
require_text "scripts/capture-reproducible-build-handoff.sh"
