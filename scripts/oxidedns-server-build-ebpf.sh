...
manifest="$repo_root/crates/oxidedns-server-ebpf/Cargo.toml"
...
target_dir="$repo_root/crates/oxidedns-server-ebpf/target/bpfel-unknown-none/release"
artifact="$target_dir/liboxidedns_server_ebpf.so"
object="$target_dir/oxidedns-xdp-redirect.bpf.o"
